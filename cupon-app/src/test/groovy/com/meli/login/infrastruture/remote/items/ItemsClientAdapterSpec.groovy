...
import com.meli.login.infrastruture.config.WebClientConfig
import com.meli.login.testutils.WireMockInitializer
...
//    }
    ...
    def "test de integracion"() {
        ...
        when:
        def mono = itemsClient.getItem(new IdItem("MLA1"))
